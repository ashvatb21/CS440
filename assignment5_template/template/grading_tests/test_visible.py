...
class grading_tests(unittest.TestCase):
    ...
    #     general_test(self, load_game(0), 'minimax_game%d_depth%d'%(0,1), search.minimax, 1)
    # @weight(5)
    # def test_minimax02(self):
    #     general_test(self, load_game(0), 'minimax_game%d_depth%d'%(0,2), search.minimax, 2)
    # @weight(5)
    # def test_alphabeta02(self):
    #     general_test(self, load_game(0), 'alphabeta_game%d_depth%d'%(0,2), search.alphabeta, 2)
    @weight(5)
    def test_stochastic053(self):
        #test_stochastic(self, 0, 5, 3)
        general_test(self, load_game(0), 'stochastic_game%d_depth%d_breadth%d'%(0,5,3),
                     search.stochastic, 5, 3)        
    @weight(5)
    def test_stochastic062(self):
        #test_stochastic(self, 0, 6, 2)
        general_test(self, load_game(0), 'stochastic_game%d_depth%d_breadth%d'%(0,6,2),
                     search.stochastic, 6, 2)                

    # @weight(5)
    # def test_minimax11(self):
    #     general_test(self, load_game(1), 'minimax_game%d_depth%d'%(1,1), search.minimax, 1)
    # @weight(5)
    # def test_minimax12(self):
    #     general_test(self, load_game(1), 'minimax_game%d_depth%d'%(1,2), search.minimax, 2)
    # @weight(5)
    # def test_alphabeta12(self):
    #     general_test(self, load_game(1), 'alphabeta_game%d_depth%d'%(1,2), search.alphabeta, 2)
    # @weight(5)
    # def test_alphabeta13(self):
    #     general_test(self, load_game(1), 'alphabeta_game%d_depth%d'%(1,3), search.alphabeta, 3)
    @weight(5)
    def test_stochastic162(self):
        general_test(self, load_game(1), 'stochastic_game%d_depth%d_breadth%d'%(1,6,2),
                     search.stochastic, 6, 2)                
        #test_stochastic(self, 1, 6, 2)
